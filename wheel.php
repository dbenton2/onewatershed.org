...
<title>OneWatershed</title>
    ...
    function spinWheelRight(){
        ...
        $('.indicator').attr('src',locationString);
    }
...
<div id="left_column">
  ...
  <div class="dropdown">
    <button onclick="loadSlice(14)" class="dropbtn">Social Sciences Literate</button>
  ...
  <div class="dropdown">
    <button onclick="loadSlice(15)" class="dropbtn">Underwater Exploration Literate</button>
  ...
  <div class="dropdown">
    <button onclick="loadSlice(16)" class="dropbtn">Water Quality Literate</button>
  ...
  <div class="dropdown">
    <button onclick="loadSlice(17)" class="dropbtn">Watershed Literate</button>
  ...
  <div class="dropdown">
    <button onclick="loadSlice(18)" class="dropbtn">Weather Literate</button>
  ...
  <div class="dropdown">
    <button onclick="loadSlice(19)" class="dropbtn">TREE</button>
    <div id="dropdown_19" class="dropdown-content">
      <a href="lesson.php?topic=<?php echo urlencode('Climate Influences & Carbon Sequestration');?>">Climate Influences & Carbon Sequestration</a>
      <a href="lesson.php?topic=<?php echo urlencode('Forests');?>">Forests</a>
      <a href="lesson.php?topic=<?php echo urlencode('Trees & Water Quality');?>">Trees & Water Quality</a>
      <a href="lesson.php?topic=<?php echo urlencode('Tree Measurements & Growth');?>">Tree Measurements & Growth</a>
      <a href="lesson.php?topic=<?php echo urlencode('Tree ID');?>">Tree ID</a>
      <a href="lesson.php?topic=<?php echo urlencode('Ecosystem Services & Tree Values');?>">Ecosystem Services & Tree Values</a>
      <a href="lesson.php?topic=<?php echo urlencode('Tree Basics');?>">Tree Basics</a>
      <a href="lesson.php?topic=<?php echo urlencode('Seasons');?>">Seasons</a>
    </div>
  </div>
</div>
...
<div id="indicator">
<img class="indicator" src="Images/Pie_Slices/Pie_Slice_1.png">
</div>
<div class="buttons">
