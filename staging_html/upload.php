...
<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      if (empty($_FILES['pdf']['name'])){
          ...
          $fileName = str_replace(' ','_', basename($_FILES["pdf"]["name"]));
      }
...
//all checks are done      
      ...
      if ($fileType != "doc" && $fileType != "docx"){
          $error2 = "* Please select a Word file for upload.";
          $error = "* Please reselect the grade level(s) for this lesson.";
          $uploadOk = 0;
      }
      ...
      if ($uploadOk == 0){
          ...
          if (move_uploaded_file($_FILES["pdf"]["tmp_name"], $target_file)){
  	      ...
  	      $sql = "INSERT INTO uploaded_data (Name, Primary_Subject, Secondary_Subject, Language, PDF_link, Grade_ID, Person, Recommended_Theme, Recommended_Topic)
   	              Values ('$lessonName', '$lessonType', '$lessonType2', '$language', '$fileName', '$gradeID', '$uploaderName', '$theme', '$topic')";
   	      ...
   	      if ($con->query($sql) === TRUE){
 	          ...
 	          $sql1 = "INSERT INTO standards (Standard, Subject)
   	                   Values ('$standard1','$lessonType')";
   	          ...
   	          if ($con->query($sql1) === TRUE){
  	              ...
  	              if ($con->query($sql7) === TRUE){ 
   	                      ...
   	                      if ($standard2 <> NULL){
   	                          $sql5 = "INSERT INTO standards (Standard, Subject)
   	                                   Values ('$standard2','$lessonType')";
