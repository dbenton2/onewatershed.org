...
if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true && $_SESSION['accessLevel'] == 'admin'){
    ...
    elseif (isset($_POST['modify'])){
        ...
        echo "<th>Upload New Lesson Plan<div>Upload New Lesson Plan</div></th>";
        echo "<th>Person<div>Person</div></th></tr></thead><tbody>";
        $y = 0;
        for($x =0; $x < count($_POST); $x++){
            if ($_POST[$x] == 'on'){
                ...
                echo "<td><input type='file' name='pdf".$y."'><br><br></td>";
                //echo "<td><input type='text' name='person" .$y."' value='$person'/></td>";
                echo "</tr>";
